            ...
            @csrf
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="">
                        ...
                        <x-input label="Nome" name="name" type="text" value="{{ old('name') }}" class="mb-4" />
                        <x-input label="Tag" name="tag" type="text" value="{{ old('tag') }}" class="mb-4" />
                        <x-input label="Link" name="link" type="text" value="{{ old('link') }}"
                            class="col-span-2"
                            />
                    </div>
                ...
                <div class="flex gap-4 justify-end items-center ">
                    <a href="{{ route('dashboard')}}" class="inline-block px-12 py-2 rounded-full my-6 bg-darkSecondary border border-accentOrange text-accentOrange hover:bg-accentOrange hover:text-white">Cancelar</a>
